...
public class AzureusCoreImpl
    ...
    protected AzureusCoreImpl() {
        ...
        instance_manager =
            ...
            public AZInstanceTracked.TrackTarget track(
                    byte[] hash) {
                    ...
                    public void handleEvent(
                        ...
                        if (ev.getType() == DHTPlugin.EVENT_DHT_AVAILABLE) {
                            ...
                            if (first_dht) {
                                ...
                                dht.addListener(
                                        new DHTListener() {
                                    public void speedTesterAvailable(
    ...
    public void triggerLifeCycleComponentCreated(
    ...
    public AzureusCoreOperation createOperation(
            final int type) {
    ...
    protected void reportCurrentTask(
            AzureusCoreOperation op,
            String currentTask) {
