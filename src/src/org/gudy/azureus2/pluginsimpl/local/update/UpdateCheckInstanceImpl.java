...
public class UpdateCheckInstanceImpl
    ...
    public void addUpdatableComponent(
...
//            }.start();
    ...
    protected UpdateImpl addUpdate(
    ...
    public void addDecisionListener(
            UpdateManagerDecisionListener l) {
        decision_listeners.add(l);
    }

    public void removeDecisionListener(
            UpdateManagerDecisionListener l) {
