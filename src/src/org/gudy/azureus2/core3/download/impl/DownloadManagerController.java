...
//	  				}
    ...
    /**
     * Determine if the download is complete, excluding DND files. This function
     * is mostly cached when there is a DiskManager.
     *
    ...
    public byte[] getTorrentInfoDict(
            PEPeer peer) {
        try {
