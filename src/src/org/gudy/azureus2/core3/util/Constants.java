...
Constants 
{
  ...
  public static final String AZUREUS_VERSION  = "4.9.0.1_B28";
  public static final String BUILD_VERSION  = "4901-28";   //Ant replace
  	...
  	String	version )
  {
	...
	{	
		try{
			version_1 = version_1.replaceAll( "_B28", "_B100" );
			version_2 = version_2.replaceAll( "_B28", "_B100" );
