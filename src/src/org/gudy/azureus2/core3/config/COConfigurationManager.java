...
public class COConfigurationManager {
    ...
    public static ConfigurationManager initialiseFromMap(
            Map data) {
        preInitialise();
    ...
    /**
     * @deprecated You should set ConfigurationDefaults, and use
     * {@link #getBooleanParameter(String)}
     */
    public static boolean getBooleanParameter(
            String _name,
            boolean _default) {
    ...
    /**
     * Only use this for internal values, NOT for ones that the user can
     * sensibly change. In this case add the key to the configuration defaults
    ...
    public static byte[] getByteParameter(
            String _name,
            byte[] _default) {
    ...
    public static String getDirectoryParameter(
            String _name)
            throws IOException {
     ...
     * definitely stored explicitly, <tt>false</tt> means that we'll also check
    ...
    /**
     * Mark as needing a save but not immediately - use when potentially needing
     * a large number of saves that aren't absolutely required to be immediately
     * persisted
     */
     ...
     * @return
     */
    public static boolean doesParameterDefaultExist(
            String parameter) {
    ...
    public static void setIntDefault(
            String parameter,
            int _default) {
        ConfigurationDefaults.getInstance().addParameter(parameter, _default);
    }

    public static void setLongDefault(
            String parameter,
            long _default) {
        ConfigurationDefaults.getInstance().addParameter(parameter, _default);
    }

    public static void setStringDefault(
            String parameter,
            String _default) {
        ConfigurationDefaults.getInstance().addParameter(parameter, _default);
    }

    public static void setByteDefault(
            String parameter,
            byte[] _default) {
        ConfigurationDefaults.getInstance().addParameter(parameter, _default);
    }
