...
public class MyDownloadPanel extends javax.swing.JPanel {
    ...
    private       net.downloader.ui.mydownload.MyDownloadFilter myDownloadFilter1;
...
//        jButton1.setHorizontalAlignment(SwingConstants.LEFT);
    ...
    private void initComponents() {
        ...
        myDownloadFilter1 = new net.downloader.ui.mydownload.MyDownloadFilter();
        ...
        allDownloadTable.getColumnModel().getColumn(4).setCellEditor(new net.downloader.ui.mydownload.ProgressCellRenderer());
        allDownloadTable.getColumnModel().getColumn(4).setCellRenderer(new net.downloader.ui.mydownload.ProgressCellRenderer());
        ...
        allDownloadTable.getColumnModel().getColumn(7).setCellEditor(new net.downloader.ui.mydownload.RemoveButtonCellRenderer(new JCheckBox()));
        allDownloadTable.getColumnModel().getColumn(7).setCellRenderer(new net.downloader.ui.mydownload.RemoveButtonCellRenderer(new JCheckBox()));
